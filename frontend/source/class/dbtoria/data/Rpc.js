...
/**
 * Initialize an Rpc object which accesses a local cgi server
 * when called from the source version of the application
 */
qx.Class.define('dbtoria.data.Rpc', {
    ...
    members : {
         ...
         *
         * Note that the handler method only gets a return value
            ...
            var superHandler = function(ret, exc, id) {
                if (exc && exc.code == 6) {
                    ...
                    login.addListenerOnce('login', function(e) {
                        origArguments.callee.base.apply(
                            origThis,
                            origArguments
                        );
                    });
