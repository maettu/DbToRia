 ...
 * form for data editing. This window also allows for searching,
    ...
    members : {
        ...
        __cellChange: function(e) {
            ...
            this.__refTimer.addListener('interval', function(e) {
                ...
                rpc.callAsyncSmart(qx.lang.Function.bind(
                    this.__referenceHandler,
                    this),
      ...
      __buildUi : function(tableId, viewMode, readOnly) {
            ...
            var editButton = this.__tbEdit = new qx.ui.toolbar.Button(
                this.tr("Edit"),
                "icon/16/apps/utilities-text-editor.png").set(
                    {enabled: false}
                );

            var cloneButton = this.__tbClone = new qx.ui.toolbar.Button(
                this.tr("Clone"),
                "icon/16/actions/edit-copy.png").set({enabled: false}
            );
            ...
            this.__rpc.callAsyncSmart(function(ret) {
                ...
                var model = new dbtoria.data.RemoteTableModel(
                    tableId,
                    columnIds,
                    columnLabels,
                    columnReferences
        ...
        __switchRecord : function(e) {
            this.debug('TablePage.__switchRecord()');
            ...
            var currentRow,
                currentSelection = selMod.getSelectedRanges()[0];
